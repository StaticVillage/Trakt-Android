...
import com.staticvillage.traktandroid.util.RetrofitUtil;
...
import static com.staticvillage.traktandroid.util.Constants.EXTENDED;
import static com.staticvillage.traktandroid.util.Constants.LIMIT;
import static com.staticvillage.traktandroid.util.Constants.PAGE;
import static com.staticvillage.traktandroid.util.Constants.PERIOD;
...
public class TraktService {
     ...
     * @param filters  filters {@link com.staticvillage.traktandroid.util.MovieFilterBuilder}
     ...
     */
    public Observable<List<PlayedMovie>> getPlayedMovies(String period,
                                                         int page,
                                                         int limit,
                                                         boolean extended,
                                                         Map<String, String> filters) {
     ...
     */
    public Observable<List<WatchedMovie>> getWatchedMovies(String period,
                                                           int page,
                                                           int limit,
                                                           boolean extended,
                                                           Map<String, String> filters) {
     ...
     */
    public Observable<List<CollectedMovie>> getCollectedMovies(String period,
                                                               int page,
                                                               int limit,
                                                               boolean extended,
                                                               Map<String, String> filters) {
    ...
    public Observable<Movie> getMovieDetails(String id, boolean extended) {
        Map<String, String> params = addExtendedInfo(extended, null);
        return api.getMovieSummary(id, params);
    }
     ...
     */
    public Observable<List<Release>> getMovieReleases(String id, String country) {
     ...
     */
    public Observable<List<Movie>> getRelatedMovies(String id, boolean extended, Map<String, String> filters) {
        filters = addExtendedInfo(extended, filters);
    ...
    /**
     * A single person's details
     *
     * @param id       Trakt.tv ID, Trakt.tv slug, or IMDB ID
     * @param extended extended info
     * @return a single person's details
     */
    public Observable<Person> getPerson(String id, boolean extended) {
        Map<String, String> filters = addExtendedInfo(extended);
        return api.getPerson(id, filters);
    }

    /**
     * All movies where this person is in the cast or crew.
     * Each cast object will have a character and a standard movie object.
     *
     * The crew object will be broken up into production, art, crew, costume & make-up,
     * directing, writing, sound, and camera (if there are people for those crew positions).
     ...
     */
    public Observable<MovieCrew> getMovieCredits(String id, boolean extended) {
        Map<String, String> filters = addExtendedInfo(extended);
        return api.getMovieCredits(id, filters);
    }
     ...
     * @return show credits
     */
    public Observable<ShowCrew> getShowCredits(String id, boolean extended) {
        Map<String, String> filters = addExtendedInfo(extended);
        return api.getShowCredits(id, filters);
    }
    //</editor-fold>
     ...
     * @param query    query
     * @param extended extended info
     * @param filters  filters {@link com.staticvillage.traktandroid.util.ShowFilterBuilder}
     * @return search results
     */
     ...
     * @param query    query
     * @param extended extended info
     * @param filters  filters {@link com.staticvillage.traktandroid.util.FilterBuilder}
     * @return search results
     */
     ...
     * @return played shows
     */
    public Observable<List<PlayedShow>> getPlayedShows(String period,
                                                       int page,
                                                       int limit,
                                                       boolean extended,
                                                       Map<String, String> filters) {
     ...
     */
    public Observable<List<WatchedShow>> getWatchedShows(String period,
                                                         int page,
                                                         int limit,
                                                         boolean extended,
                                                         Map<String, String> filters) {
     ...
     */
    public Observable<List<CollectionShow>> getCollectedShows(String period,
                                                          int page,
                                                          int limit,
                                                          boolean extended,
                                                          Map<String, String> filters) {
    ...
    public Observable<Show> getShowDetails(String id, boolean extended) {
        Map<String, String> params = addExtendedInfo(extended, null);
        return api.getShowSummary(id, params);
    }
     ...
     * @return appended parameter map
     */
    private Map<String, String> addExtendedInfo(boolean extended) {
        return addExtendedInfo(extended, new HashMap<>());
    }
